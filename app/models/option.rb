class Option < Ohm::Model
  ...
  attribute :prevclose         # Previous closing price
  ...
  def quote= quote
    [:symbol, :description, :option_type, :exch, :change, :change_percentage, :volume, :average_volume, :last_price, :last_volume, :last_trade_date, :open, :high, :low, :close, :prevclose, :bid_price, :bid_size, :bid_exch, :bid_date, :ask_price, :ask_size, :ask_exch, :ask_date, :open_interest, :underlying, :strike, :contract_size, :expiration_date, :expiration_type, :price_spread, :days_to_expiration].each do |field|
